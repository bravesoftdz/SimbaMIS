object FormInvoiceManager: TFormInvoiceManager
  Left = 0
  Top = 0
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = #21457#31080#31649#29702#31995#32479
  ClientHeight = 592
  ClientWidth = 827
  Color = clBtnFace
  ...
  object RzListView: TRzListView
    ...
    Columns = <
      ...
      item
        Alignment = taCenter
        Caption = #21345#21495'/'#25163#26426#21495
        Width = 120
      end
      item
        Alignment = taRightJustify
        Caption = #20805#20540'/'#28040#36153#37329#39069
        Width = 100
      end
      item
        Alignment = taCenter
        Caption = #20805#20540'/'#28040#36153#26085#26399
        Width = 180
      end
      item
        Alignment = taRightJustify
      ...
      item
        Alignment = taRightJustify
        Caption = #21097#20313#24320#31080#39069#24230
        Width = 228
      end>
    FlatScrollBars = True
    GridLines = True
  ...
  object RzPanel2: TRzPanel
    ...
    object RzRadioGroupInvoiceType: TRzRadioGroup
      ...
      GroupStyle = gsBanner
      Items.Strings = (
        #20250#21592#20805#20540#21457#31080
        #39038#23458#28040#36153#21457#31080)
      ParentCtl3D = False
      StartXPos = 0
      StartYPos = 0
      TabOrder = 0
      VerticalSpacing = 5
      OnClick = RzRadioGroupInvoiceTypeClick
    end
    object RzPageControlKey: TRzPageControl
      Left = 216
      Top = 11
      Width = 300
      Height = 55
      ...
      object TabSheet2: TRzTabSheet
        ...
        object RzEditTelNo: TRzEdit
          Left = 85
          Top = 22
          Width = 127
          Height = 25
          TabOrder = 0
          OnChange = RzEditTelNoChange
        end
      end
    end
  end
