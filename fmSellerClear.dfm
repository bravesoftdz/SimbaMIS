object FormSellerClear: TFormSellerClear
  Left = 0
  Top = 0
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = #20379#24212#21830#24080#21153#32467#31639
  ClientHeight = 431
  ClientWidth = 698
  Color = clBtnFace
  ...
  object RzPanel2: TRzPanel
    ...
    object RzComboBoxSellerList: TRzComboBox
      ...
      ItemHeight = 17
      TabOrder = 0
      OnChange = RzComboBoxSellerListChange
    end
  end
  object RzListView: TRzListView
    ...
    Columns = <
      ...
      item
        Caption = #37319#21697#31181#31867
        Width = 200
      end
      item
        Alignment = taRightJustify
        Caption = #37319#21697#21512#35745
        Width = 200
      end>
    FlatScrollBars = True
    GridLines = True
    ...
    TabOrder = 1
    ViewStyle = vsReport
    OnItemChecked = RzListViewItemChecked
  end
  object RzPanel1: TRzPanel
    ...
    object RzLabelPay: TRzLabel
      ...
      Margins.Bottom = 0
      Align = alLeft
      Caption = #32467#31639#21512#35745#65306
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clBlack
      Font.Height = -15
      Font.Name = #24494#36719#38597#40657
    ...
    object RzButtonAdd: TRzButton
      ...
      Cancel = True
      Anchors = [akRight, akBottom]
      Caption = #32467#31639#23436#27605
      TabOrder = 0
