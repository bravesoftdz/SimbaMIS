object FormMemberDetail: TFormMemberDetail
  Left = 0
  Top = 0
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = #20250#21592#28040#36153#26126#32454#26597#35810
  ClientHeight = 510
  ClientWidth = 758
  Color = clBtnFace
  ...
  object RzPanel1: TRzPanel
    ...
    object RzButtonPrint: TRzButton
      Left = 434
      Top = 5
      Width = 100
      Height = 33
      ...
      Caption = #25171#21360
      TabOrder = 1
      OnClick = RzButtonPrintClick
    end
    object RzButtonReturn: TRzButton
      Left = 542
      Top = 5
      Width = 100
      Height = 33
  ...
  object RzListView: TRzListView
    ...
    Columns = <
      ...
      item
        Alignment = taCenter
        Caption = #26126#32454#31867#22411
        Width = 100
      end
      item
        Alignment = taCenter
  ...
  object RzPanel2: TRzPanel
    ...
    object RzRadioGroupDetailType: TRzRadioGroup
      Left = 74
      Top = 16
      Width = 239
      Height = 17
      ...
      GroupStyle = gsBanner
      Items.Strings = (
        #20840#37096#26126#32454
        #20805#20540#26126#32454
        #28040#36153#26126#32454)
      ParentCtl3D = False
      StartXPos = 0
      StartYPos = 0
      TabOrder = 0
      VerticalSpacing = 0
      OnClick = RzRadioGroupDetailTypeClick
    end
  end
  ...
  object PopupMenuDesign: TPopupMenu
    ...
    object popMenuDesign: TMenuItem
      Caption = #26126#32454#25968#25454#26684#24335
      OnClick = popMenuDesignClick
    end
    object popMenuPreview: TMenuItem
      Caption = #39044#35272#26126#32454
  ...
  object frxUserDataSetMemberDetail: TfrxUserDataSet
    UserName = 'frxUserDataSetMemberDetail'
    Fields.Strings = (
      'date'
      'type'
      'nums')
    OnGetValue = frxUserDataSetMemberDetailGetValue
    Left = 264
    Top = 312
  end
